...
- **[acgs-lite](https://github.com/dislovelhl/acgs-lite)** - An open-source Python governance layer for AI agents that blocks unsafe actions before execution, enforces MACI separation of powers, and keeps tamper-evident audit trails.
